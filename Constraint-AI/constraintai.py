...
Original file is located at
    https://colab.research.google.com/drive/1Q8Azqvkt05YYhAjYs8YeAqFuGbYyI-BV
"""
...
trainFilename = "/content/drive/MyDrive/Colab Notebooks/Constrain AI/Constraint_English_Train - Sheet1.tsv"
validFilename = "/content/drive/MyDrive/Colab Notebooks/Constrain AI/Constraint_English_Val - Sheet1.tsv"
...
train_y = torch.tensor(trainLabels.tolist())

val_seq = torch.tensor(tokens_val['input_ids'])
val_mask = torch.tensor(tokens_val['attention_mask'])
val_y = torch.tensor(validLabels.tolist())

test_seq = torch.tensor(tokens_test['input_ids'])
test_mask = torch.tensor(tokens_test['attention_mask'])
test_y = torch.tensor(testLabels.tolist())
...
for epoch in range(epochs):
    ...
    if valid_loss < best_valid_loss:
        ...
        torch.save(model.state_dict(), '/content/drive/MyDrive/Colab Notebooks/Constrain AI/saved_weights.pt')
...
path = '/content/drive/MyDrive/Colab Notebooks/Constrain AI/saved_weights.pt'
